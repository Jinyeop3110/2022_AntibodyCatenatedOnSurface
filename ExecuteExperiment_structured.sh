...
matlab -nodisplay -nosplash -r "ExperimentSession_fig6_0624($SLURM_ARRAY_TASK_ID,40,2)"
matlab -nodisplay -nosplash -r "ExperimentSession_fig6_0624($SLURM_ARRAY_TASK_ID,40,1)"
